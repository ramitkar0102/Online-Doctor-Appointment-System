...
<title>Online Doctor Appointment - Admin</title>
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Online Doctor Appointment System</span>Login <span class="msg">Sign in to start your session</span></h1>
        <div class="col-md-12">
